...
const KNOWN_CAUSE: { kind?: string; path: RegExp; why: string }[] = [
  ...
  { path: /^(customer|organization|job|asset|property|request_source|team|estimate|estimate\.job|customer_organization|customer\.customer_organization)\.updated_at$/,
